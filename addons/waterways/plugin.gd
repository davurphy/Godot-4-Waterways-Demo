...
func _enter_tree() -> void:
	...
	add_custom_type("WaterRippleField", "Node3D", preload("./water_ripple_field.gd"), preload("./icons/ripple_field.svg"))
	add_custom_type("WaterRippleEmitter", "Node3D", preload("./water_ripple_emitter.gd"), preload("./icons/ripple_emitter.svg"))
...
func _exit_tree() -> void:
	...
	remove_custom_type("WaterRippleField")
	remove_custom_type("WaterRippleEmitter")
