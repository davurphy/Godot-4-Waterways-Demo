...
Recommended next move: regenerate the main and obstacle-test river bakes to signature `20`, then review the same pillow targets with the raw/final/source-term debug views. Keep `pillow_forward_reach_tiles = 0.0` while reviewing and leave WaterSystem/physics data untouched.
