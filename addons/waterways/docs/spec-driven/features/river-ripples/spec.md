...
- Decide and document whether ripple nodes are built-in custom types or prototype/example nodes before presenting them as public API.
...
- If nodes are prototype-only, docs and registration must not imply public add-on API stability.
