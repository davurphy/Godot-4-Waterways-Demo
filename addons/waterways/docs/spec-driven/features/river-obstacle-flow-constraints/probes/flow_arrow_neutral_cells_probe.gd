...
#
#   & $godotConsole --headless --path $root --script res://addons/waterways/docs/spec-driven/features/river-obstacle-flow-constraints/probes/flow_arrow_neutral_cells_probe.gd
extends SceneTree
...
func _run() -> void:
	...
	overlay.save_png(out_base + "/arrow_neutral_cells_main_demo.png")
	print("wrote ", out_base, "/arrow_neutral_cells_main_demo.png")
	quit(0)
